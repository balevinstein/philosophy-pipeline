...
class MoveRefinementWorker(RefinementWorker):
        ...
        try:
            ...
            if not sections and response.strip():
                ...
                if len(parts) > 1:
                    ...
                    sections["Refinement Changes"] = "Refinement Changes" + parts[1].strip()
                else:
                    sections["Refined Development"] = response.strip()
                    sections["Refinement Changes"] = "- Implemented refinements based on critique"
    ...
    def _extract_changes(self, changes_text: str) -> List[str]:
        ...
        for line in changes_text.split("\n"):
            ...
            if line and (line.startswith("- ") or line.startswith("* ") or 
                ...
                changes.append(line[2:] if line.startswith("- ") or line.startswith("* ") 
    ...
    def validate_output(self, output: WorkerOutput) -> bool:
        ...
        development_sections = ["Refined Development", "Development", "Updated Development", "Final Development"]
        changes_sections = ["Refinement Changes", "Changes", "Changes Made", "Modifications"]
        ...
        if not has_development:
            print(f"Warning: Missing development section. Need one of: {development_sections}")
