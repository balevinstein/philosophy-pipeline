...
"""
    ...
    def process_output(self, raw_output: str) -> WorkerOutput:
        ...
        output = WorkerOutput(
            ...
            notes={"section_count": len(sections), "assessment": assessment},
            status="completed",
        )
    ...
    def validate_output(self, output: WorkerOutput) -> bool:
        ...
        if not content or not content.strip():
            ...
            print(
                f"Available fields in modifications: {list(output.modifications.keys())}"
            )
    ...
    def __call__(self, input_data: WorkerInput) -> WorkerOutput:
        ...
        if "error" in context:
            ...
            return WorkerOutput(
                modifications={"error": context["error"]}, status="error"
            )
