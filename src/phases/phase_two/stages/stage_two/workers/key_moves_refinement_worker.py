...
from ..prompts.key_moves_refinement_prompts import KeyMovesRefinementPrompts
...
class KeyMovesRefinementWorker(FrameworkWorker):
    ...
    def __init__(self, config: Dict):
        ...
        self.prompts = KeyMovesRefinementPrompts()
    ...
    def _extract_decisions(self, decisions_section: Dict[str, str]) -> Dict[str, List[dict]]:
    ...
    def process_output(self, response: str) -> WorkerOutput:
        ...
        try:
                ...
                if line.startswith('# '):  # Main section
                    ...
                    if current_section:
                        if current_subsection:
                            print(f"Saving subsection {current_subsection} under {current_section}")
                    ...
                    if current_section == 'Refinement Decisions':
                        ...
                        sections[current_section] = {}  # Initialize as dict for subsections
                elif line.startswith('## ') and current_section == 'Refinement Decisions':  # Subsection
            ...
            # Extract decisions
            decisions = self._extract_decisions(sections.get('Refinement Decisions', {}))
