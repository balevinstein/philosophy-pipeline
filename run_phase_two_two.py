...
def caffeinate():
    ...
    try:
        ...
        print("You may want to manually prevent your system from sleeping during execution.")
...
def main():
    ...
    try:
        ...
        for cycle in range(num_cycles):
            ...
            # Save critique
            json.dump({"critique": critique.modifications}, 
            ...
            # Save refinement
            json.dump({"refinement": refined.modifications},
        ...
        json.dump({"outline": final_outline},
        ...
        }, open(framework_dir / "phase_two_two_output.json", "w"), indent=2)
        ...
        }, open(framework_dir / "development_history.json", "w"), indent=2)
